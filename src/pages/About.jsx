...
function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-proxima">
      <div
        style={{
      ...
      >
        <Navbar />
        <div className="flex flex-col justify-center items-center text-center text-white py-48 animate-fade-in">
          <h1 className="text-5xl sm:text-7xl font-gotham font-bold tracking-[0.25em] mb-6 uppercase text-gold drop-shadow-xl">About Us</h1>
      ...
      <section className="py-24 px-4 sm:px-10 bg-white">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          <h2 className="text-4xl sm:text-5xl font-gotham font-bold tracking-wider text-black">Our Story</h2>
      ...
      <section className="py-24 px-4 sm:px-10 bg-gray-50">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl sm:text-4xl font-gotham font-bold tracking-wider text-[#b0984b]">Marcus Filheim</h3>
      ...
      <section className="py-24 px-4 sm:px-10 bg-black text-white">
        <div className="text-center max-w-4xl mx-auto mb-20">
          <h2 className="text-4xl sm:text-5xl font-gotham font-bold tracking-wide">Why Choose Filheim</h2>
          <p className="text-lg sm:text-xl text-white/80 mt-4">
      ...
      <section className="py-24 px-4 sm:px-10 bg-white">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-gotham font-bold tracking-wide">Our Team</h2>
